...
from typed_boto3.core.config import AwsCredentials, ClientConfig
...
__all__ = ["ApigatewayClient", "Apigatewayv2Client", "AthenaClient", "AwsCredentials", "BedrockClient", "ClientConfig", "CloudformationClient", "CloudwatchClient", "CognitoIdpClient", "DynamodbClient", "Ec2Client", "EcsClient", "Elbv2Client", "EventsClient", "FirehoseClient", "GlueClient", "IamClient", "KinesisClient", "KmsClient", "LambdaClient", "LogsClient", "RdsClient", "RedshiftClient", "Region", "Route53Client", "S3Client", "SagemakerClient", "SecretsmanagerClient", "ServiceName", "SnsClient", "SqsClient", "SsmClient", "StepfunctionsClient", "StsClient", "client"]
# --- END GENERATED ---
